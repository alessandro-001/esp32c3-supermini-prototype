...
// NOTE: Group assignment via REST API requires ThingsBoard PE or paid Cloud.
// On the free plan, devices are automatically discoverable via the Device Profile.
// Use a "Device type" alias in your dashboard pointing to BOSS_FARM_DEVICES profile
// instead of a "Group entities" alias — this requires zero manual steps.
